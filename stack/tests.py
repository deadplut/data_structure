...
from stack.stack_list import StackList
...
empty_list = StackList()
test_list = StackList(node_1)
...
unsorted_list = StackList(unsorted_node_1)
...
# ###################
node_111 = Node('1123')
empty_list.push(node_111)

node_1113 = Node('1132123')
test_list.push(node_1113)
