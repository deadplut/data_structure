from double_linked_list.double_link_list import Node
from queueq.queue_list import QueueList
...
empty_list = QueueList()
test_list = QueueList(node_1)
...
unsorted_list = QueueList(unsorted_node_1)
