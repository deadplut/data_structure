from double_linked_list.double_link_list import Node, DoubleLinkedList
...
test_list = DoubleLinkedList(node_1)
...
unsorted_list = DoubleLinkedList(unsorted_node_1)
...
# ###################
#
# empty_list.print_list(reverse=True)
# test_list.print_list(reverse=True)
#
# print('\n')
# print('~'*20)
###################
...
# empty_list.print_list()
#
# test_list.append(node_8_test, '1')
# test_list.print_list()
#
# print('\n')
# print('~'*20)
...
# empty_list.print_list()
#
# test_list.prepend(node_8_test, '6')
# test_list.print_list()
#
# print('\n')
# print('~'*20)
...
###################
# #
empty_list.rearrangement(node_2, node_1)
test_list.rearrangement(node_1, node_6)
